...
import (
	...
	apicuritosv1alpha1 "github.com/apicurito-operator/pkg/apis/apicuritos/v1alpha1"
...
func (r *ReconcileApicurito) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	err = r.client.Get(context.TODO(), types.NamespacedName{Name: apicurito.Name, Namespace: apicurito.Namespace}, found)
	if err != nil && errors.IsNotFound(err) {
...
func getImage(a *apicuritosv1alpha1.Apicurito) string {
	...
	return "apicurio/apicurito-ui"
}

// getImageTag returns the apicurito docker image tag from Spec if defined in CR, or
// it's default value
func getTag(a *apicuritosv1alpha1.Apicurito) string {
	if a.Spec.ImageTag != "" {
